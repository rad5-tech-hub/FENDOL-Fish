    ...
    <main className="pt-0">
        ...
        <div className="relative z-10 px-6 md:px-16 max-w-[1440px] mx-auto w-full pt-20 grid grid-cols-1 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Link href="/market" className="bg-secondary text-on-secondary px-10 py-4 font-sans text-sm items-center justify-center flex tracking-tight hover:opacity-90 transition-opacity uppercase font-bold rounded-sm shadow-xl">
                Shop Fish
              </Link>
              <Link href="/distributors" className="border border-white/40 text-white px-10 py-4 font-sans text-sm items-center justify-center flex tracking-tight hover:bg-white/10 transition-colors uppercase font-bold rounded-sm">
      ...
      <section className="py-24 px-6 md:px-16 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <Link href="/about" className="inline-flex items-center gap-3 text-primary font-black uppercase tracking-widest text-sm hover:text-secondary transition-colors">
      ...
      <section className="py-24 px-6 md:px-16 max-w-[1440px] mx-auto bg-surface-container/20">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
          ...
          <Link href="/market" className="p-4 bg-primary text-on-primary font-sans text-xs font-black hover:bg-secondary hover:text-on-secondary transition-all uppercase tracking-widest rounded-sm shadow-lg">
      ...
      <section className="py-24 px-6 md:px-16 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <Link href="/track" className="inline-flex items-center gap-3 text-primary font-black uppercase tracking-widest text-sm hover:text-secondary transition-colors">
        ...
        <div className="px-6 md:px-16 max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/distributors" className="inline-flex justify-center items-center bg-secondary text-on-secondary px-10 py-4 font-sans text-xs tracking-widest hover:bg-white hover:text-primary transition-all uppercase font-black shadow-2xl rounded-sm">
                Become a Distributor
              </Link>
              <Link href="/distributors#apply" className="inline-flex justify-center items-center border border-on-primary/30 text-on-primary px-10 py-4 font-sans text-xs tracking-widest hover:bg-on-primary/10 transition-all uppercase font-black rounded-sm">
                Apply Now
              </Link>
            </div>
          </div>
